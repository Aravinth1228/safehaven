...
const ADMIN_WALLET = '0x548cb269df02005590CF48fb031dD697e52aa201'; // Demo admin wallet
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  // Blockchain-based admin verification
  const verifyAdminOnChain = useCallback(async (walletAddress: string): Promise<boolean> => {
    try {
      ...
      // Check if wallet is admin on the smart contract
      ...
      console.error('Failed to verify admin on blockchain:', error);
      setIsAdmin(false);
      setAdminWalletAddress(null);
      localStorage.removeItem('adminWalletAddress');
      return false;
